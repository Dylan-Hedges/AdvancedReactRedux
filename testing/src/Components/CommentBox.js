...
//Imports requireAuth component to be used for authentication checks (will act as parent to CommentBox)
...
//Wires up action creators to component, wraps CommentBox inside of requireAuth and calls it - as there is no mapStateToProps we put null as the first argument
