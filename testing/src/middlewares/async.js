//Redux Promise middleware recreation - middleware that handles asynchronous requests, is a function that returns a function that returns a function
export default ({dispatch}) => next => action => {
  ...
  action.payload.then(function(response){
    ...
    //Dispatches the new action - flows through all of the middlewares again
    dispatch(newAction);
  });
};
